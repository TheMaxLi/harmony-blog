...
— Max & The Team
  `,
		author: {
			name: 'Max Shuyu Li',
			profileIconSrc: '/assets/images/max.jpg'
		},
		thumbnailSrc: '/src/lib/assets/images/week-1.gif'
	},
...
Stay tuned for next week’s update as the team continues to refine and develop *Harmony*!
  ...
  `,
		author: 'Chelsea Woo',
		thumbnailSrc: '/src/lib/assets/images/week-2.gif'
	}
];

export function getBlogByTitle(title: string) {
	return blogs.find((blog) => encodeURI(blog.title) === encodeURI(title));
}
